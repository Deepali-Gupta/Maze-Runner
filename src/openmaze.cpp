...
//Initial values of ip addresses and playernames
...
#define PLAYER_FILE "per1.bmp"
#define AI1_FILE "per1.bmp"
#define AI2_FILE "per2.bmp"
#define AI3_FILE "per3.bmp"
#define AI4_FILE "per4.bmp"
#define AI5_FILE "per5.bmp"
...
static GLuint hintfile;
 static GLuint treasure;
...
if (i==1&&i!=my_id)
	glBindTexture(GL_TEXTURE_2D,ai1);
	else if (i==2&&i!=my_id)
	glBindTexture(GL_TEXTURE_2D,ai2);
	
	else if (i==3&&i!=my_id)
	glBindTexture(GL_TEXTURE_2D,ai3);
	
	else if (i==4&&i!=my_id)
	glBindTexture(GL_TEXTURE_2D,ai4);
	
	else if (i==5&&i!=my_id)
	glBindTexture(GL_TEXTURE_2D,ai5);
...
{ 
 ...
 { 
  ...
  treasure=maketex(TREASURE_FILE,TEXTURE_SIZE,TEXTURE_SIZE);
    person=maketex(PLAYER_FILE,TEXTURE_SIZE,TEXTURE_SIZE);
    ai1=maketex(AI1_FILE,TEXTURE_SIZE,TEXTURE_SIZE);
    ai2=maketex(AI2_FILE,TEXTURE_SIZE,TEXTURE_SIZE);
    ai3=maketex(AI3_FILE,TEXTURE_SIZE,TEXTURE_SIZE);
    ai4=maketex(AI4_FILE,TEXTURE_SIZE,TEXTURE_SIZE);
    ai5=maketex(AI5_FILE,TEXTURE_SIZE,TEXTURE_SIZE);
...
std::cout<<"x_at"<<x_at[my_id]<<"y_at"<<y_at[my_id]<<std::endl;
...
void* ai_func(void *args)
{
	int i = (long int) args;
	if (i==1)
	{
	system ("g++ -w -o ai_2 openmaze_ai2.cpp udp_client.cpp udp_server.cpp -lpthread -lglut -lGL -lGLU -lGLEW");
	 system ("./ai_2");
	}
	if (i==2)
	{
	system ("g++ -w -o ai_3 openmaze_ai3.cpp udp_client.cpp udp_server.cpp -lpthread -lglut -lGL -lGLU -lGLEW");
	 system ("./ai_3");
	}	
	if (i==3)
	{
	system ("g++ -w -o ai_4 openmaze_ai4.cpp udp_client.cpp udp_server.cpp -lpthread -lglut -lGL -lGLU -lGLEW");
	 system ("./ai_4");
	}	
	if (i==4)
	{
	system ("g++ -w -o ai_5 openmaze_ai5.cpp udp_client.cpp udp_server.cpp -lpthread -lglut -lGL -lGLU -lGLEW");
	 system ("./ai_5");
	}	
	if (i==5)
	{
	system ("g++ -w -o ai_6 openmaze_ai6.cpp udp_client.cpp udp_server.cpp -lpthread -lglut -lGL -lGLU -lGLEW");
	 system ("./ai_6 6 5");
	}		
}
...
if (my_id==0){
pthread_t t_ai;
	for (int i=TOTAL_PLAYERS;i<=5;i++)
		pthread_create(&t_ai, NULL, ai_func,(void*)i);
	 }
 ...
 glutCreateWindow("Mazerunner Player");
